// Rate Policy Actions
resource "akamai_appsec_rate_policy_action" "juice_shop_ase_automatic_policy_origin_error" {
...
resource "akamai_appsec_rate_policy_action" "juice_shop_ase_automatic_policy_page_view_requests" {
  config_id          = akamai_appsec_configuration.config.config_id
  security_policy_id = akamai_appsec_rate_protection.juice_shop_ase_automatic_policy.security_policy_id
...
resource "akamai_appsec_rate_policy_action" "juice_shop_ase_automatic_policy_post_page_requests" {
  config_id          = akamai_appsec_configuration.config.config_id
  security_policy_id = akamai_appsec_rate_protection.juice_shop_ase_automatic_policy.security_policy_id
